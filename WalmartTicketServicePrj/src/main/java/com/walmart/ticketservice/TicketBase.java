 ...
 *
 * @author Neha
This class has all information of levels,seathold etc
 */
public class TicketBase {
    ...
    private static AtomicInteger seat_Id = new AtomicInteger(600);
    private static AtomicInteger cust_Id = new AtomicInteger(100);
    ...
    //Created hashmap for getting levels info
